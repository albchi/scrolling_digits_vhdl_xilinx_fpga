## File       : rolling_digit.xdc
## Description: This is a Xilinx design contraint file needed to 1) map VHDL entity ports to Basys3
##              board signals 2) create clock 
## Tools      : Xilinx Vivado for 1) synthesis 2) implementation (place & route) 3) bitstream generation 
